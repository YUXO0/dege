...
os.execute('lua 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .lua')
end
...
local 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙  = io.open("𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ", 'w')
𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ :write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .lua
done
]])
𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ :close()
...
screen -S ]]..Redis:get(SshId.."Info:Redis:User")..[[ ./𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ 
done
]])
Run:close()
...
os.execute('chmod +x 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ;chmod +x Run;./Run')
end
...
𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙  = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ )
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ,token=Token}
function var(value)  
...
Status = 0
DevelopersQ = Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",UserId) 
HELPBEVQ = Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups",UserId) 
Developers = Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",UserId) 
TheBasics = Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..ChatId,UserId)
...
elseif UserId == 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙  then
Status = 'البوت'
...
Status = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif Distinguished then
Status = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."lockpin"..ChatId) then    
lock_pin = "✅"
else 
lock_pin = "❎"    
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:tagservr"..ChatId) then    
lock_tagservr = "✅"
else 
lock_tagservr = "❎"
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:text"..ChatId) then    
lock_text = "✅"
else 
lock_text = "❎ "    
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✅"
else 
lock_add = "❎ "    
end    
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Join"..ChatId) == "kick" then
lock_join = "✅"
else 
lock_join = "❎ "    
end    
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:edit"..ChatId) then    
lock_edit = "✅"
else 
lock_edit = "❎ "    
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Chek:Welcome"..ChatId) then
welcome = "✅"
else 
welcome = "❎ "    
end
if Redis:hget(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✅"
else     
flood = "❎ "     
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Photo"..ChatId) == "del" then
lock_photo = "✅" 
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❎ "   
end    
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Contact"..ChatId) == "del" then
lock_phon = "✅" 
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❎ "    
end    
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Link"..ChatId) == "del" then
lock_links = "✅"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❎ "    
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✅"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❎ "    
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:User:Name"..ChatId) == "del" then
lock_user = "✅"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❎ "    
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✅"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❎ "    
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:vico"..ChatId) == "del" then
lock_muse = "✅"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❎ "    
end 
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Video"..ChatId) == "del" then
lock_ved = "✅"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❎ "    
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Animation"..ChatId) == "del" then
lock_gif = "✅"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❎ "    
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✅"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❎ "    
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:geam"..ChatId) == "del" then
lock_geam = "✅"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❎ "    
end    
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✅"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❎ "
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:forward"..ChatId) == "del" then
lock_fwd = "✅"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❎ "    
end    
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Document"..ChatId) == "del" then
lock_file = "✅"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❎ "    
end    
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✅"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❎ "    
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✅"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❎ "    
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✅"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❎ "    
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✅"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❎ "    
end        
...
return{
BanAll = Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."BanAll:Groups",UserId) ,
ktmall = Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Channel:Join')
if Channel then
...
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."allM"..msg.chat_id, msg.id)
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."allM"..msg.chat_id)
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."allM"..msg.chat_id)
end
end
end
if tonumber(msg.sender.user_id) == tonumber(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ) then
...
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'المساعد'
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ) then
return false
end

local floods = Redis:hget(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'lock:Cht'..msg.chat_id) and not msg.Distinguished then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
sens = 400  
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."lockpin"..msg_chat_id)
...
Redis:incr(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ) then
local N = (Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Name:Bot") or "𝗕𝗔𝗡𝗗𝗔 ⸙")
photo = LuaTele.getUserProfilePhotos(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ )
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖥔 ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖥔 تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Filter:Group:"..DelFilters..msg_chat_id)
if ReplyFilters then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return LuaTele.sendText(msg_chat_id,msg_id,"*𖥔 لقد تم منع هذه ( "..statusfilter.." ) هنا*\n𖥔 "..ReplyFilters,"md",true)   
end
end
if text and Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Get:Reides:Commands:Group"..text)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Command:List:Group",text)
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Command:List:Group",text)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ الامر باسم ← { "..text..' }',"md",true)
end

if text and Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم ازالة هاذا ← { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"𖥔 لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:Reids:Group:New"..msg_chat_id)
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:List:Group"..msg_chat_id,text)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ ترحيب الجروب","md",true)     
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Group:Rules" .. msg_chat_id,text) 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ قوانين الجروب","md",true)  
end  
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v, 0,""..text.."")
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"𖥔  تم حذف الرد من الردود ","md",true)  
return false
end
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙  then
local test = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..v..text)
end
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔  تم حذف الرد من الردود العامه","md",true)  
end
end
if text then
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:File"..text)
local audio = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text then
local anemi = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'GetTexting:Dev𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ '..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر 𖥔' then 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'GetTexting:Dev𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ '..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم الغاء حفظ كليشة المطور')
end
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Texting:Dev𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ',text)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'GetTexting:Dev𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ '..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم حفظ كليشة المطور')
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم تعين الايدي عام',"md",true)  
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تعين الايدي","md",true)  
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "𖥔  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "𖥔  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Smile"..msg.chat_id) then
if text == Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Smile"..msg.chat_id) then
Redis:incrby(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Smile"..msg.chat_id)
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Monotonous"..msg.chat_id) then
if text == Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Monotonous"..msg.chat_id) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Monotonous"..msg.chat_id)
Redis:incrby(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Countrygof"..msg.chat_id) then
Redis:incrby(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Countrygof"..msg.chat_id)
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Riddles"..msg.chat_id) then
if text == Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Riddles"..msg.chat_id) then
Redis:incrby(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Riddles"..msg.chat_id)
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Meaningof"..msg.chat_id) then
Redis:incrby(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Meaningof"..msg.chat_id)
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Reflection"..msg.chat_id) then
if text == Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Reflection"..msg.chat_id) then
Redis:incrby(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Reflection"..msg.chat_id)
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Difference"..msg.chat_id) then
if text == Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Difference"..msg.chat_id) then 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Difference"..msg.chat_id)
Redis:incrby(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Example"..msg.chat_id) then
if text == Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Example"..msg.chat_id) then 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Example"..msg.chat_id)
Redis:incrby(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Get:Reides:Commands:Group"..text) or Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Channel:Join')}, },}}
...
if tonumber(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..GroupId,v)
end
end 
end
...
if text == 'رفع نسخه 𝗕𝗔𝗡𝗗𝗔 ⸙' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ) then 
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..idg,idASAS)
end;end
end
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم استرجاع المجموعات من نسخه 𝗕𝗔𝗡𝗗𝗔 ⸙')
else
...
os.execute('rm -rf 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .lua')
os.execute('wget https://adfrv.zzz.com.ua/beb/𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .lua')
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."SendBcBot") 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."SendBcBot",true) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."LeftBot") 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."AddSudosNew"..msg_chat_id)
...
local Groups = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'ChekBotAdd')  
local UsersBot = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:User:Pv')  
local Get_Json = '{"BotId": '..𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..v)
local Constructor = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..v)
local Manager = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..v)
local Admin = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..v)
local Vips = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Channel:Redis'..msg_chat_id..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر 𖥔' then 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(bana.id,𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖥔 البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Channel:Join',ChannelUser) 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Channel:Redis'..msg_chat_id..msg.sender.user_id,true)
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Channel:Join')
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*𖥔 عدد احصائيات البوت الكامله \n⩹━━━━𖥕𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ 𖥕━━━━⩺\n𖥔 عدد المجموعات : '..(Redis:scard(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'ChekBotAdd') or 0)..'\n𖥔 عدد المشتركين : '..(Redis:scard(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."ChekBotAdd",msg_chat_id)
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Id"..msg_chat_id,true) ;Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Reply"..msg_chat_id,true) ;Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:BanId"..msg_chat_id,true) ;Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."ChekBotAdd",msg_chat_id) then
...
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."ChekBotAdd",msg_chat_id) then
if text == "ايدي" or text =='id' or text =='Id' or text == 'ID' and msg.reply_to_message_id == 0 then
if not Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Id"..msg_chat_id) then
return false
end
...
local TotalMsg = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Id:Groups") or Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Id:Group"..msg_chat_id)
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."allM:numdel"..msg.chat_id,Numbardel) 
...
local list = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."allM"..msg.chat_id)  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Del:Media"..msg.chat_id)
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Del:Media"..msg.chat_id,true)
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 البوت عضو في الجروب ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✅ ❭' else change_info = '❬ ❎ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",bana.id) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups")
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups", bana.id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."id:HELPBEVQ:Groups", bana.id)
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",bana.id) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups")
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups")
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups", UserId)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."id:HELPBEVQ:Groups", UserId)
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",UserId) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",bana.id) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups")
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups", UserId)
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",bana.id) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id,bana.id) 
...
if not msg.Originators and not Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups")
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",UserId) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."HELPBEVQ:Groups",UserId) then
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",UserId) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 لا يوجد مطورين حاليا , ","md",true)  
end
...
local Info_Members = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Reply"..msg_chat_id,true) 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:BanId"..msg_chat_id,true) 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."BotFree",true) 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TwaslBot",true) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Id"..msg_chat_id) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:IdPhoto"..msg_chat_id) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Reply"..msg_chat_id) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:ReplySudo"..msg_chat_id) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:BanId"..msg_chat_id) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."BotFree") 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TwaslBot") 
...
if text == "نزلني" then
if not Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔??𝗗𝗔 ⸙ .."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
local TestText = "  ❲ Developers 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙   ❳\n— — — — — — — — —\n 𖥔*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n𖥔 *Dev Bio* : [❲ "..Bio.." ❳]"
local msg_id = msg.id/2097152/0.5 
...
if text == 'ديجي' or text == 'باندا' or text == 'المبرمج' then  
local UserId_Info = LuaTele.searchPublicChat("YU_X0")
...
if photo.total_count > 0 then
local TestText = "  ❲ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙   Source ❳\n— — — — — — — — —\n 𖥔*Dev Name* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n𖥔 *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '< Developers 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙   >', url = "https://t.me/YU_X0"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'ديجي'  or text == 'المبرمج' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
local id = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."id:HELPBEVQ:Groups")
...
local Added_Me = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Who:Added:Me"..msg.sender.user_id..':'..msg.sender.user_id)
if Added_Me then 
...
if not Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."rb:bna"..msg_chat_id) then
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."lockalllll"..msg_chat_id) == "off" then
...
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."cleaner"..msg_chat_id,msg_id)
end
if text == "مسح الميديا" then 
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 هاذا الامر يخص⦗ '..Controller_Num(6)..' ⦘* ',"md",true)  
end
local list = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."cleaner"..msg_chat_id)
if #list == 0 then 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."cleaner"..msg_chat_id)
...
---زخرفة ----
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."zhrfa"..msg.sender.user_id) == "sendzh" then
...
LuaTele.sendText(msg_chat_id,msg_id,t,"md",true) 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."zhrfa"..msg.sender.user_id) 
end



if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
if not msg.ControllerBot and not Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."LeftBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𖥔 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local reply_markup = LuaTele.replyMarkup{
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:text"..msg_chat_id,true) 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."lockalllll"..msg_chat_id,"off")
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."lockalllll"..msg_chat_id,"on")
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:edit"..msg_chat_id,true) 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..''..lock..msg_chat_id,"del")    
end
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:text"..msg_chat_id)  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Join"..msg_chat_id)  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:tagservr"..msg_chat_id)  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."lockpin"..msg_chat_id)  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:edit"..msg_chat_id) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..''..lock..msg_chat_id)    
end
...
Redis:hset(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Link"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:User:Name"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:hashtak"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖥔 تم قفـل السب").Lock,"md",true)  
end
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'lock:Fshar'..msg.chat_id) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖥔 تم فتح السب").unLock,"md",true)  
end
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'lock:Fars'..msg.chat_id) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Cmd"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Photo"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Video"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Animation"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:geam"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Audio"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:vico"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Sticker"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:forward"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Document"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Contact"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..msg_chat_id)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔  تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
Redis:setex(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Welcome"..msg_chat_id) then
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Welcome:Group"..msg_chat_id) 
...
Redis:setex(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم ازالة قوانين الجروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Filter:Group:"..v..msg_chat_id)  
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Get:Reides:Commands:Group"..v)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ← {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
{
{text = 'اتعطيل ردود السورس', data = msg.sender.user_id..'/'.. 'rb:bna_ban'},{text = 'اتفعيل ردود السورس', data = msg.sender.user_id..'/'.. 'rb:bna_𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ '},
},
{
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✅ ❭' else Statuslink = '❬ ❎ ❭'
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✅ ❭' else StatusWelcome = '❬ ❎ ❭'
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Id"..msg.chat_id) then
StatusId = '❬ ✅ ❭' else StatusId = '❬ ❎ ❭'
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✅ ❭' else StatusIdPhoto = '❬ ❎ ❭'
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✅ ❭' else StatusReply = '❬ ❎ ❭'
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✅ ❭' else StatusReplySudo = '❬ ❎ ❭'
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✅ ❭' else StatusBanId = '❬ ❎ ❭'
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✅ ❭' else StatusSetId = '❬ ❎ ❭'
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✅ ❭' else StatusGames = '❬ ❎ ❭'
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✅ ❭' else Statuskickme = '❬ ❎ ❭'
end
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '•ᴍʏ ᴄʜᴀɴɴᴇʟ♪', url = 't.me/Y0_OI'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Rink = 1
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups",bana.id)  then
Rink = 2
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups",bana.id)  then
Rink = 3
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..msg_chat_id, bana.id) then
Rink = 4
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id, bana.id) then
Rink = 5
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id, bana.id) then
Rink = 6
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id, bana.id) then
Rink = 7
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id, bana.id) then
Rink = 8
elseif Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id, bana.id) then
Rink = 9
else
Rink = 10
end
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد رسائلك هنا *~ '..(Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد التعديلات هنا *~ '..(Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد جهاتك المضافه هنا *~ '..(Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
𖥔 ارسل الان النص
𖥔 يمكنك اضافه :
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Id:Groups")
...
Redis:setex(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
𖥔 ارسل الان النص
𖥔 يمكنك اضافه :
𖥔 `#username` » اسم المستخدم
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Id:Group"..msg.chat_id)
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."DevelopersQ:Groups") 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Developers:Groups") 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..msg_chat_id) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..msg_chat_id) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..msg_chat_id) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..msg_chat_id) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..msg_chat_id) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."BanAll:Groups") 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."ktmAll:Groups") 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."BanGroup:Group"..msg_chat_id) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Manager"..msg_chat_id)
end
...
text = "𖥔 قائمه الردود \n⩹━━━━𖥕𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ 𖥕━━━━⩺\n"
for k,v in pairs(list) do
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف 𖥔"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الان الكلمه لحذفها من الردود","md",true)  
end
if text and not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group"..msg.sender.user_id,text) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group"..msg.sender.user_id) 
end
...
local list = Redis:smembers(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Gif"..v)   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:vico"..v)   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:stekr"..v)     
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Text"..v)   
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Photoc"..v)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Photo"..v)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Video"..v)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:File"..v)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Audio"..v)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:video_note"..v)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Rd:Sudo")
end
...
text = "\n📝︙قائمة الردود العامه \n⩹━━━━𖥕𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ 𖥕━━━━⩺\n"
for k,v in pairs(list) do
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:File"..v) then
db = "ملف 𖥔"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Channel:Join')}, },}}
...
Redis:setex(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
BanAll = 'محظور عام ,'
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."BanAll:Groups",Message_Reply.sender.user_id) 
else
BanAll = ''
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).BanGroup == true then
BanGroup = 'محظور ,'
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
else
BanGroup = ''
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).SilentGroup == true then
SilentGroup = 'مكتوم ,'
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
else
SilentGroup = ''
end
...
BanAll = 'محظور عام ,'
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."BanAll:Groups",bana.id) 
else
BanAll = ''
end
if Statusrestricted(msg_chat_id,bana.id).BanGroup == true then
BanGroup = 'محظور ,'
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."BanGroup:Group"..msg_chat_id,bana.id) 
else
BanGroup = ''
end
if Statusrestricted(msg_chat_id,bana.id).SilentGroup == true then
SilentGroup = 'مكتوم ,'
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."SilentGroup:Group"..msg_chat_id,bana.id) 
else
SilentGroup = ''
end
LuaTele.sendText(msg_chat_id,msg_id,"\n*𖥔 تم رفع القيود عنه : {"..BanAll..BanGroup..SilentGroup..Restricted..'}*',"md",true)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'GetTexting:Dev𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ '..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Texting:Dev𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ')
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '•ᴍʏ ᴄʜᴀɴɴᴇʟ♪',url="https://t.me/Y0_OI"}}
}
local msg_id = msg.id/2097152/0.5
...
local Name = '* ╭───── •𖥔• ─────╮\n*𖥔 [𝑆𝑂𝑈𝑅𝐶𝐸 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ](t.me/Y0_OI)*\n*𖥔 [ 𝑮𝑹𝑶𝑼𝑷 𝑺𝑶𝑼𝑹𝑪𝑬](t.me/YUI_O0)*\n*𖥔 [⋆⃟➼𝘿𝙀𝙂𝙀𝙆𝙊𝙊𝙇 ꕸ](t.me/YU_X0)*\n*𖥔 [𝘼𝙎𝙆 𝙏𝙊 𝙈𝙀 ☬ ](t.me/YU_X0)*\n╰───── • 𖥔 • ─────╯\n⍟ 𝑻𝑯𝑬 𝑩𝑬𝑺𝑻 𝑶𝑵 𝑺𝑶𝑼𝑹𝑪𝑬 ⏎*'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
Redis:setex(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حذف اسم البوت ","md",true)   
end
if text == 'بوت' or text == 'البوت' then
local photo = LuaTele.getUserProfilePhotos(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ )
local ban = LuaTele.getUser(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ )
local Namebot = (Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Name:Bot") or "𝗕𝗔𝗡𝗗𝗔 ⸙")
local BotName = {
...
if text == (Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Name:Bot") or "𝗕𝗔𝗡𝗗𝗔 ⸙") then
local photo = LuaTele.getUserProfilePhotos(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ )
local ban = LuaTele.getUser(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ )
local Namebot = (Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Name:Bot") or "𝗕𝗔𝗡𝗗𝗔 ⸙")
local BotName = {
...
x = x + 1
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ )
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*𖥔 البوت عظو في الجروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Smile"..msg.chat_id,SM)
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Games"..msg.chat_id) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Country"..msg.chat_id)
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Countrygof"..msg.chat_id,name)
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Monotonous"..msg.chat_id,name)
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Games"..msg.chat_id) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Games"..msg.chat_id) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Reflection"..msg.chat_id,name)
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Difference"..msg.chat_id,name)
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
local ban = LuaTele.getUser(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ )
local bain = LuaTele.getUser(msg.sender.user_id)
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Start:Bot") then
...
local CmdStart = '*\n𖥔 أهلآ بك في بوت '..(Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Name:Bot") or "𝗕𝗔𝗡𝗗𝗔 ⸙")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
...
{
{text ='الكاتب',type = 'text'},{text = 'المطور',type = 'text'},
},
{
{text = 'ديجي',type = 'text'},{text = 'المبرمج ديجي',type = 'text'},
},
{
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(??𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𖥔 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
 ioserver = io.popen([[
...
keyboardd.inline_keyboard = {
{
{text = '< Developers 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙   >', url = "https://t.me/M_P_L_6"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'المبرمج ديجي' or text == 'ديجي' or text == 'الكاتب' or text =='ديجي' then  
...
keyboardd.inline_keyboard = {
{
{text = '< Developers 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙   >', url = "https://t.me/BoOdY_BaSha"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
Redis:setex(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TwaslBot") and not Redis:sismember(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'𖥔 تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'BaN:In:Tuasl',Info_User)  
...
Redis:srem(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'*'..'-100'..data.supergroup.id..'*')
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."List:Manager"..'-100'..data.supergroup.id)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙  then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:edit"..data.chat_id) then
...
Redis:incrby(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Num:Add:Games"..ChatId..IdUser, 1)  
...
local TextHelp = [[*
• أهلا بك في قائمة العاب سورس 𝗕𝗔𝗡𝗗𝗔 ⸙ اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس 𝗕𝗔𝗡𝗗𝗔 ⸙ 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."zhrfa"..IdUser,"sendzh") 
end 
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*𖥔 ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."zhrfa"..IdUser,"sendzh") 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."rank_tf"..IdUser,"rank_tk") 
end
end 
...
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."AddSudosNew"..ChatId,true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."AddSudosNew"..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."rb:bna"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"𖥔 تم تعطيل امر الايدي").unLock, 'md', true, false, reply_markup)
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"𖥔 تم تفعيل امر الالعاب").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/rb:bna_𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ') then
local UserId = Text:match('(%d+)/rb:bna_𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."rb:bna"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"𖥔 تم تفعيل امر اطردني").unLock, 'md', true, false, reply_markup)
end
end
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..''..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ ..''..lock..UserId[2],"del")    
end
LuaTele.answerCallbackQuery(data.id, "𖥔 تم قفل جميع الاوامر بنجاح  ", true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"𖥔 تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗔𝗡𝗗𝗔 ⸙ .."SilentGroup:Group"..ChatId) 
